document.addEventListener('DOMContentLoaded', function () {
    ...
    function verifyCaptcha() {
        ...
        if (inputText === captchaText.toLowerCase()) {
            ...
            captchaStatus.textContent = 'Inclua todos os caracteres!';
            captchaStatus.style.color = 'red';
        } else {
            captchaStatus.textContent = 'Captcha incorreto. Por favor, tente novamente!';
            captchaStatus.style.color = 'red';
        }
        setTimeout(() => {
            captchaStatus.textContent = 'Status : INATIVO';
